  ...
  return (
    <div className="w-full px-4 py-5 bg-gradient-to-b  ">
      ...
      <div className="relative rounded-3xl border bg-white/80  p-5 overflow-hidden">
        ...
        <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-blue-200 rounded-full blur-3xl opacity-20"></div>
        ...
        <div className="flex items-center justify-between relative z-10">
          ...
          <div className="flex flex-col items-center flex-1 group">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-pink-100 to-pink-50 flex items-center justify-center shadow-sm transition">
          ...
          {/* Quality */}
          <div className="flex flex-col items-center flex-1 group">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center shadow-sm  transition">
              <span className="text-xl">✔️</span>
            </div>
            <p className="mt-2 text-xs font-medium text-gray-800 tracking-wide">
              Quality Checked
